...
// Only a direct role-based threat (e.g. voting whoever is about to out you) overrides the
// human's social pressure. Every other vote rationale can be re-pointed by the player.
function voteReasonResistsHumanInfluence(reasonKind: TargetDecision["reasonKind"]): boolean {
  return reasonKind === "role_threat";
}
